 ...
 */
public class SubTopologyFamilyElement1FamilyElement extends AbstractProcessor {
     ...
     */
    public SubTopologyFamilyElement1FamilyElement(String name, String namespace, boolean sendMonitoringEvents, 
        boolean sendRegular) {
