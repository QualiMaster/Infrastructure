...
public class SpringHistoricalDataProvider implements IHistoricalDataProvider,Serializable
{
	...
	private static final String[] DEFAULT_MONITORED_TERMS = {"NASDAQ·NFLX"}; //"NASDAQ·AAPL","NASDAQ·AMAT", //"NYSE·CHK","NASDAQ·CSCO","NASDAQ·FB","NASDAQ·GOOGL","NYSE·IBM","NASDAQ·MU","NYSE_MKT·VHC"};
