...
echo $CLASSPATH
exec java -Dstorm.conf.file=conf/storm.yaml -Dqm.home.dir=$QM_HOME -classpath $CLASSPATH:$STORM_HOME eu.qualimaster.adaptation.platform.SwClusterMonitoringTest $*